...
class U_home extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'u_home/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'u_home/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'u_home/index.html';
            $config['first_url'] = base_url() . 'u_home/index.html';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = TRUE;
        $config['total_rows'] = $this->U_home_model->total_rows($q);
        $u_home = $this->U_home_model->get_limit_data($config['per_page'], $start, $q);
        ...
        $this->load->view('u_home/home', $data);
    }

    public function read($id) 
    {
        $row = $this->U_home_model->get_by_id($id);
        if ($row) {
            $data = array(
		'no' => $row->no,
		...
		'program_yang_diambil' => $row->program_yang_diambil,
            ...
            $this->load->view('u_home/kedatangan_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('u_home'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('u_home/create_action'),
	    'no' => set_value('no'),
        ...
        $this->load->view('u_home/kedatangan_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('u_home/update_action'),
    ...
    public function update_action() 
    {
		...
		'program_yang_diambil' => $this->input->post('program_yang_diambil',TRUE),
            ...
            $this->U_home_model->update($this->input->post('no', TRUE), $data);
...
/* End of file U_home.php */
/* Location: ./application/controllers/U_home.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2023-03-20 06:41:31 */
/* http://harviacode.com */
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="http://localhost/janitra/u_home" class="logo d-flex align-items-center">
    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card-box bg-red">
                ...
                <a href="http://localhost/janitra/u_home" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
        <div class="col-lg-3 col-sm-6">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card-box bg-green">
                ...
                <a href="http://localhost/janitra/u_dat" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card-box bg-orange">
                ...
                <a href="http://localhost/janitra/u_dat/create.html" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
    <!-- DAftar Card -->

...
<html>
    <head>
        <title>Registrasi Online | Admin </title>
 ...
 <link href="<?php echo base_url('assets/jquery/jquery.datetimepicker.min.css') ?>">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="http://pendaftaran.dedypriyanto.my.id/a_home" class="logo d-flex align-items-center">
...
<!---Menu Dafrat-->
 <div class="card">
        ...
        <a href="<?php echo site_url('/a_home') ?>" class="btn btn-danger">Cancel</a>
    </form>
